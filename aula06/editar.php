        ...
        <form action="salvar_edicao.php" method="POST">
            ...
            <div class="form-grid">
                <div class="field full">
                    ...
                    <input type="text" id="produto" name="produto" value="<?= $cliente['produto'] ?>" required>
                </div>

                <div class="field">
                    <label for="descricao">Descrição</label>
                    <input type="text" id="descricao" name="descricao" value="<?= $cliente['descricao'] ?>" required>
                </div>

                <div class="field">
                    <label for="preco">Preço</label>
                    <input type="text" id="preco" name="preco" value="<?= $cliente['preco'] ?>" required>
                </div>
            </div>

            <div class="buttons">
                <button type="submit" class="submit">Salvar</button>
                <a href="loja.php" class="btn cancel">Cancelar</a>
            </div>
        </form>
